    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardTitle className="text-2xl font-bold">UG Gymnasium</CardTitle>
          <CardDescription>Admin Panel - Sign in to your account</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 text-center text-sm text-muted-foreground">
            <p>© 2026 University of Ghana Gymnasium</p>
          </div>
        </CardContent>
      </Card>
    </div>
