...
const Footer = () => {
  return (
    <footer className="border-t bg-muted/40 bg-[#002147]/90 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/contact#faq" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start space-x-2 text-sm text-muted-foreground">
                ...
                <span>+233 (0) 555 419 992</span>
              </li>
              <li className="flex items-start space-x-2 text-sm text-muted-foreground">
                <Mail className="h-4 w-4 mt-0.5 shrink-0" />
                <span>info@gymnasium.ug.edu.gh</span>
              </li>
            </ul>
          </div>
        </div>
